...
namespace W1
{
    public partial class frmLibro : Form
    {
        ...
        {
            Usuarios usuario = new Usuarios() { Nro_documento = "1234567", Nombre = "Jose", Apellido = "Gonzalez", Email = "jgonzalez@intro.com.py", Direccion = "su casa", Contrasenha="prueba123", CargoUsuario=Cargo.usuario };
